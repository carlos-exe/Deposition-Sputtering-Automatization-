...
# Inicializa el puerto (reemplaza 'COM3' con tu puerto real)
LX16A.initialize('COM3')

LX16A.IDRead()
# Crea una instancia del servo con ID 1
# servo = LX16A(1)

# # Establece la velocidad del servo a 500 (ajusta según sea necesario)
# servo.motorMode(920)

# # Deja el motor girando por 5 segundos
# sleep(5)
